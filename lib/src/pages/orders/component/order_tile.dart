...
import 'package:loja_virtual/src/pages/orders/component/order_status_widget.dart';
        ...
        child: ExpansionTile(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                utilsServices.formatDateTime(widget.orderModel.orderCreationDt),
          ...
          children: [
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: SizedBox(
                      height: 150,
                      child: ListView(
                        children: widget.orderModel.items.map((order) {
            ...
            Text.rich(
              TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text:
                        utilsServices.priceToCurrency(widget.orderModel.total),
                  ),
                ],
              ),
            ),
            ...
            Visibility(
              visible: widget.orderModel.status == 'pending_payment',
